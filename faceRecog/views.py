...
def create_dataset(request):
    ...
    faceDetect = cv2.CascadeClassifier('C:/Users/joseph/Desktop/facial-recognition-python-django/ml/haarcascade_frontalface_default.xml')
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('C:/Users/joseph/Desktop/facial-recognition-python-django/ml/dataset/user.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = 'C:/Users/joseph/Desktop/facial-recognition-python-django/ml/dataset'
    ...
    recognizer.save('C:/Users/joseph/Desktop/facial-recognition-python-django/ml/recognizer/trainingData.yml')
    cv2.destroyAllWindows()
...
def detect(request):
    ...
    rec.read('C:/Users/joseph/Desktop/facial-recognition-python-django/ml/recognizer/trainingData.yml')
    getId = 0
...
def eigenTrain(request):
    ...
    '''
    svm_pkl_filename = 'C:/Users/joseph/Desktop/facial-recognition-python-django/ml/serializer/svm_classifier.pkl'
    ...
    pca_pkl_filename = 'C:/Users/joseph/Desktop/facial-recognition-python-django/ml/serializer/pca_state.pkl'
    # Open the file to save as pkl file
...
def detectImage(request):
    ...
    svm_model = {} # scores is an empty dict already

    if os.path.getsize(svm_pkl_filename) > 0:      
        with open(svm_pkl_filename, "rb") as f:
            unpickler = pickle.Unpickler(f)
            # if file is not empty scores will be equal
            # to the value unpickled
            svm_model = unpickler.load()
    ...
    if os.path.getsize(pca_pkl_filename) > 0:      
    ...
    #im.show()
    imgPath = 'C:/Users/joseph/Desktop/facial-recognition-python-django/ml/uploadedImages/'+str(userImage)
